...
import { cloneSegmentEffects, defaultSegmentEffects } from "../model/segmentEffects";
...
// Renderer-safe: file IO (loadProject/saveProject) intentionally omitted here —
// the daemon copy keeps those; in the Electron app, project files are read/written
// over IPC. serialize/deserialize above are pure and run anywhere.
