		...
		return (
			...
			>
				<div className="text-center">
					<div className="animate-spin duration-500 rounded-[50%] h-6 w-6 border-2 border-b-transparent border-primary mx-auto mb-2" />
			...
			>
				<div className="max-w-[320px] px-6 text-center">
					...
					<Button
						...
						className="mt-4 h-8 rounded-lg bg-primary px-5 text-[11px] font-semibold text-primary-foreground transition-transform duration-150 hover:bg-primary/90 active:scale-95"
					>
						{tc("actions.reload")}
					</Button>
				</div>
		...
		<div className={`min-h-screen flex flex-col ${styles.glassContainer}`}>
			...
			<div className="flex justify-center gap-2 border-t border-white/[0.06] p-3">
				...
				<Button
					...
					className="h-8 rounded-lg bg-primary px-5 text-[11px] font-semibold text-primary-foreground transition-transform duration-150 hover:bg-primary/90 active:scale-95 disabled:bg-zinc-700 disabled:opacity-30"
				>
					{tc("actions.share")}
				</Button>
			</div>
